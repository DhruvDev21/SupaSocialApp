  ...
  return (
    ...
    >
      <Path
        ...
        fill={props.color || "currentColor"} // Apply color to the fill
        stroke={props.strokeColor || "none"} // Optional: separate stroke color if needed
        strokeWidth={props.strokeWidth || 0} // Default to 0 to avoid unwanted borders
      />
    </Svg>
  );
}
